...
describe Simulacion do
  after(:each) { described_class.limpiar_log }

  describe 'registrar_ejecucion' do
    it 'debe registrar la ejecucion de la Tarea 1 en dos unidades de tiempo' do
      described_class.registrar_ejecucion('Tarea 1', 0, 2)
      expect(described_class.log).to include('0 a 2 -> Tarea 1')
    end
  end

  describe 'limpiar_log' do
    it 'debe vaciar la lista de ejecuciones' do
      described_class.registrar_ejecucion('Tarea 1', 0, 1)
      described_class.limpiar_log
